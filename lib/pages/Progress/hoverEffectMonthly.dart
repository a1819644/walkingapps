...
class HoverEffectMonthly extends StatefulWidget {
  const HoverEffectMonthly({super.key});

  static const String textName = "Weekly";

  @override
  State<HoverEffectMonthly> createState() => _HoverEffectMonthlyState();
}

class _HoverEffectMonthlyState extends State<HoverEffectMonthly> {
  bool _isTapped = true;
