...
class HoverEffectWeekly extends StatefulWidget {
  const HoverEffectWeekly({super.key});

  static const String textName = "Weekly";

  @override
  State<HoverEffectWeekly> createState() => _HoverEffectWeeklyState();
}

class _HoverEffectWeeklyState extends State<HoverEffectWeekly> {
  bool _isTapped = true;
